        ...
        {cards.map((card) => {
          ...
          return (
            <Link key={card.title} href={card.href} className="group outline-none">
              <Card className="relative overflow-hidden transition-all duration-300 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5">
                ...
                <CardHeader className="flex flex-row items-center justify-between pb-3">
                  ...
                  <div className={`flex h-10 w-10 items-center justify-center rounded-xl transition-transform group-hover:scale-110 ${card.iconBg}`}>
                  ...
                  {isLoading ? (
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-baseline justify-between">
                        ...
                        <ArrowUpRight className="h-5 w-5 text-muted-foreground opacity-0 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                      </div>
                  ...
                  {chartData.map((d) => {
                    ...
                    return (
                      <div key={d.day} className="flex-1 flex flex-col items-center gap-2 group relative">
                        <div className="absolute -top-10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10 bg-popover text-popover-foreground text-xs font-mono font-bold px-2 py-1 rounded-md shadow-md border whitespace-nowrap">
        ...
        <Card className="flex flex-col justify-between">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-xl bg-muted/40 border border-border/40">
              <span className="text-sm text-muted-foreground">Sucursales Activas</span>
              <span className="text-sm font-bold text-foreground">ERP Activo</span>
            </div>
            <div className="flex items-center justify-between p-4 rounded-xl bg-muted/40 border border-border/40">
              <span className="text-sm text-muted-foreground">Moneda Principal</span>
              <span className="text-sm font-bold text-primary">BOB (Bs)</span>
            </div>
            <div className="flex items-center justify-between p-4 rounded-xl bg-muted/40 border border-border/40">
              <span className="text-sm text-muted-foreground">Filtro de Sucursal</span>
              <span className="text-sm font-semibold text-foreground">Global / Dinámico</span>
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-1">
                <h4 className="text-base font-semibold text-foreground">Alerta de Existencias Bajas</h4>
            ...
            <Link
              href="/inventory"
              className="inline-flex items-center gap-2 rounded-xl bg-destructive px-5 py-2.5 text-sm font-semibold text-destructive-foreground shadow-sm transition-transform hover:scale-105 active:scale-95 shrink-0"
            >
